    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-12 col-md-7" data-aos="fade-right">
                <div class="m-0">
                    <p class="small fw-bolder text-uppercase tracking-wider mb-2 text-muted">Abaya Dress
                    </p>
                    <h2 class="display-5 fw-bold mb-6">Produk Abaya-Dress <br> Terbaru Kami</h2>
                                    ...
                                    <div class="card position-relative h-100 card-listing hover-trigger">
                                        <div class="card-header">
                                            <picture class="position-relative overflow-hidden d-block bg-light">
                                                <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                    src="<?= base_url(); ?>/assets/images/products/product-12.jpg"
                                                    alt="img">
                                            </picture>
                                        ...
                                        <div class="card-body px-0 text-center">
                                            ...
                                            <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                href="./product.html">Motif Hawa</a>
                                            <p class="fw-bolder m-0 mt-2">Rp1.400.000</p>
                                        </div>
                                    </div>
                                    <!--/ Card Product-->
                                    <!--/ Card-->
                                ...
                                <div class="swiper-slide overflow-hidden">
                                    ...
                                    <div class="card position-relative h-100 card-listing hover-trigger">
                                        <div class="card-header">
                                            <picture class="position-relative overflow-hidden d-block bg-light">
                                                <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                    src="<?= base_url(); ?>/assets/images/products/product-1.jpg"
                                                    alt="img">
                                            </picture>
                                            <div class="card-actions">
                                                <span
                                        ...
                                        <div class="card-body px-0 text-center">
                                            ...
                                            <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                href="./product.html">Yanara Dress</a>
                                            <p class="fw-bolder m-0 mt-2">Rp750.000</p>
                                        </div>
                                    </div>
                                    <!--/ Card Product-->
                                    <!--/ Card-->
                                ...
                                <div class="swiper-slide overflow-hidden">
                                    ...
                                    <div class="card position-relative h-100 card-listing hover-trigger">
                                        <div class="card-header">
                                            <picture class="position-relative overflow-hidden d-block bg-light">
                                                <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                    src="<?= base_url(); ?>/assets/images/products/product-13.jpg"
                                                    alt="img">
                                            </picture>
                                            <div class="card-actions">
                                                <span
                                        ...
                                        <div class="card-body px-0 text-center">
                                            ...
                                            <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                href="./product.html">Yanara Flyroam Dress</a>
                                            <p class="fw-bolder m-0 mt-2">Rp769.000</p>
                                        </div>
                                    </div>
                                    <!--/ Card Product-->
                                    <!--/ Card-->
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Sanchia Set</a>
                                                <p class="fw-bolder m-0 mt-2">Rp950.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            <div class="card-header">
                                                <picture class="position-relative overflow-hidden d-block bg-light">
                                                    <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                        src="<?= base_url(); ?>/assets/images/products/product-14.jpg"
                                                        alt="img">
                                                </picture>
                                                <div class="card-actions">
                                                    <span
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Flappy Dress</a>
                                                <p class="fw-bolder m-0 mt-2">Rp725.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            <div class="card-header">
                                                <picture class="position-relative overflow-hidden d-block bg-light">
                                                    <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                        src="<?= base_url(); ?>/assets/images/products/product-15.jpg"
                                                        alt="img">
                                                </picture>
                                                <div class="card-actions">
                                                    <span
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Almeida Dress</a>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            <div class="card-header">
                                                <picture class="position-relative overflow-hidden d-block bg-light">
                                                    <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                        src="<?= base_url(); ?>/assets/images/products/product-16.jpg"
                                                        alt="img">
                                                </picture>
                                                <div class="card-actions">
                                                    <span
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Nalara Dress</a>
                                                <p class="fw-bolder m-0 mt-2">Rp700.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            <div class="card-header">
                                                <picture class="position-relative overflow-hidden d-block bg-light">
                                                    <img class="w-100 img-fluid position-relative z-index-10" title=""
                                                        src="<?= base_url(); ?>/assets/images/products/product-2.jpg"
                                                        alt="img">
                                                </picture>
                                                <div class="card-actions">
                                                    <span
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <p class="fw-bolder m-0 mt-2">Rp790.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Flyroam</a>
                                                <p class="fw-bolder m-0 mt-2">Rp790.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Motiv Hawa</a>
                                                <p class="fw-bolder m-0 mt-2">1.400.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Flyroam</a>
                                                <p class="fw-bolder m-0 mt-2">Rp699.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Little</a>
                                                <p class="fw-bolder m-0 mt-2">Rp699.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="card position-relative h-100 card-listing hover-trigger">
                                            ...
                                            <div class="card-body px-0 text-center">
                                                ...
                                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                                    href="./product.html">New Arrival - Flyroam</a>
                                                <p class="fw-bolder m-0 mt-2">Rp799.000</p>
                                            </div>
                                        </div>
                                        <!--/ Card Product-->
                                    </div>
