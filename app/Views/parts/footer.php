<footer class="bg-dark mt-10  ">
    ...
    <div class="bg-light py-4">
        <div class="container d-flex justify-content-center align-items-center py-2">
            <p class="lead fw-bolder mb-0 lh-1">Kunjungi juga di</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 mb-3 mb-xxl-0 text-white" data-aos="fade-left">
                <div
                    ...
                    <div class="ms-lg-4">
                        ...
                        <small class="text-muted"><a class="text-muted" href="#">Klik di sini</a> untuk menghubungi
                            kami</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4 mb-3 mb-xxl-0 text-white" data-aos="fade-left" data-aos-delay="250">
                <div
                    ...
                    <div class="ms-lg-4">
                        <p class="mb-1 lh-1 fw-bold">Pengiriman gratis</p>
                        <small class="text-muted">Pengiriman gratis untuk semua pesanan di atas 800.000</small>
                    </div>
                </div>
            </div>
            <!-- / Info box-->
            ...
            <div class="col-12 col-md-4 mb-3 mb-xxl-0 text-white" data-aos="fade-left" data-aos-delay="500">
                <div
                    ...
                    <div class="ms-lg-4">
                        <p class="mb-1 lh-1 fw-bold">Pengembalian</p>
                        <small class="text-muted">Pengembalian uang kembali 30 hari jika Anda berubah pikiran</small>
                    </div>
                </div>
            </div>
            <!-- / Info box-->
        ...
        <div class="container" data-aos="fade-in">
            <div class="row my-4 flex-wrap">
                ...
                <div class="col-12 col-md-5">
                    <h6 class="mb-4 fw-bolder fs-6">Bergabunglah dengan Kami</h6>
                    <p class="opacity-75">Daftar ke buletin kami dan kami akan mengirimi Anda kode senilai 15% dari
                        pesanan pertama Anda melalui email. Dengan berlangganan milis kami, Anda menyetujui syarat dan
                        ketentuan kami.</p>
                    <form
                        ...
                        <div class="input-group m-0">
                            <input type="text" class="form-control d-flex flex-grow-1 border-0 bg-transparent py-3"
                                placeholder="Masukkan email Anda" aria-label="Masukkan email Anda">
            ...
            <div
                ...
                <p class="small opacity-75">&copy; <?= date("Y"); ?> Abaya Collection All Rights Reserved.</p>
                <nav>
                    <ul class="list-unstyled">
