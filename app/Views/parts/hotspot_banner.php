<section class="my-10 position-relative">
    ...
    <div class="w-100 h-100 bg-img-cover bg-pos-center-center hotspot-container py-5 py-md-7 py-lg-10" style="background-image: url(<?= base_url() ?>/assets/images/banners/banner-5.jpg);">
            ...
            <div class="m-n2 rounded overflow-hidden">
                <div class="mb-1 bg-light d-flex justify-content-center">
                    <div class="f-w-48 px-3 pt-3">
                        <img class="img-fluid" src="<?= base_url(); ?>/assets/images/products/product-3.jpg" alt="img">
                    </div>
                </div>
                <div class="px-4 py-4 text-center">
                    ...
                    <a href="./product.html" class="fw-bolder text-link-border pb-1 fs-6">Dress details <i class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
    </div>
