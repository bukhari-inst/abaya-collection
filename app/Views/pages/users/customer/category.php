            ...
            <div class="d-none d-lg-flex col-lg-3">
                <div class="pe-4">
                    ...
                    <aside>
                        ...
                        <form action="<?= site_url('/searchCategory') ?>" method="post">
                            <!-- Price Filter -->
                                ...
                                <div id="filter-price" class="collapse show">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-7">
                                        <div class="input-group mb-0 me-2 border">
                                            ...
                                            <input type="number" min="00" max="1000000" name="min" step="1"
                                                class="filter-min form-control-sm border flex-grow-1 text-muted border-0">
                                        </div>
                                        <div class="input-group mb-0 ms-2 border">
                                            <span
                                                class="input-group-text bg-transparent fs-7 ps-2 py-2 pe-1 text-muted border-0">Rp</span>
                                            <input type="number" min="00" max="1000000" name="max" step="1"
                                ...
                                <div id="filter-colour" class="collapse show">
                                    <div class="filter-options mt-3">
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="ungu"
                                                value="Ungu" id="filter-colours-0">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="hijau"
                                                value="Hijau" id="filter-colours-1">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="merah"
                                                value="Merah" id="filter-colours-2">
                                            <label class="form-check-label" for="filter-colours-2"></label>
                                        </div>
                                        <div
                                            class="form-group d-inline-block mr-1 mb-1 form-check-solid-bg-checkmark form-check-custom form-check-facebook">
                                            <input type="checkbox" class="form-check-color-input" name="biru"
                                                value="Biru" id="filter-colours-3">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="kuning"
                                                value="Kuning" id="filter-colours-4">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="hitam"
                                                value="Hitam" id="filter-colours-5">
                                        ...
                                        <div
                                            ...
                                            <input type="checkbox" class="form-check-color-input" name="abu" value="Abu"
                                                id="filter-colours-6">
                                            <label class="form-check-label" for="filter-colours-6"></label>
                                        </div>
                                        <div
                                            class="form-group d-inline-block mr-1 mb-1 form-check-solid-bg-checkmark form-check-custom form-check-white">
                                            <input type="checkbox" class="form-check-color-input" name="putih"
                                                value="Putih" id="filter-colours-7">
                                            <label class="form-check-label" for="filter-colours-7"></label>
                                        </div>
                                        <div
                                            class="form-group d-inline-block mr-1 mb-1 form-check-solid-bg-checkmark form-check-custom form-check-pink">
                                            <input type="checkbox" class="form-check-color-input" name="pink"
                                                value="Pink" id="filter-colours-8">
                                            <label class="form-check-label" for="filter-colours-8"></label>
                                        </div>
                                        <div
                                            class="form-group d-inline-block mr-1 mb-1 form-check-solid-bg-checkmark form-check-custom form-check-orange">
                                            <input type="checkbox" class="form-check-color-input" name="orange"
                                                value="Orange" id="filter-colours-9">
                                            <label class="form-check-label" for="filter-colours-9"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            ...
                            <div class="card-body px-0 text-center">
                                ...
                                <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                                    href="#"><?= $prd->nama ?></a>
                                <p class="fw-bolder m-0 mt-2"><?= "Rp " . number_format($prd->harga, 2, ',', '.'); ?>
                                </p>
                            </div>
                        </div>
                        <!--/ Card Product-->
