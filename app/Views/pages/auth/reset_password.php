            ...
            <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                ...
                <div class="card bg-glass">
                    <div class="card-body px-4 py-5 px-md-5">
                        ...
                        <p>Masukkan token yang Anda terima melalui email, alamat email Anda, dan
                        ...
                        <form class="user" action="<?= route_to('reset-password') ?>" method="post">
                            ...
                            <div class="form-group row mb-5">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <input id="id_password" type="password"
                                        ...
                                        name="password" placeholder="Sandi baru">
                            ...
                            <!-- reset button -->
                            <button type="submit"
                                class="btn btn-primary btn-block rounded-pill btn-user mb-4"><?= lang('Auth.resetPassword') ?></button>
                        </form>
                    </div>
                </div>
            </div>
